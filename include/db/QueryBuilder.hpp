...
namespace database {
    ...
    class QueryBuilder {
        private:
            ...
            std::vector<ColumnValue> conflict_columns;
        ...
        public:
            ...
            QueryBuilder& add_conflict(std::string column, std::optional<FunctionBuilder> function_builder = std::nullopt, std::optional<QueryBuilder> select_query = std::nullopt);
            QueryBuilder& add_conflict(ColumnValue column);
